...
def create_bar_charts(df, out_dir):
    ...
    """
    columns = ['Choose your gender', 'What is your course?', 'Your current year of Study', 'Marital status',
               'Do you have Depression?', 'Do you have Anxiety?', 'Do you have Panic attack?']
    
    titles = ['Gender Distribution', 'Course of Study Distribution', 'Year of study Distribution',
              'Marital Status Distribution', 'Depression Distribution', 'Anxiety Distribution',
              'Panic Attack Distribution']
    
    colors = [['pink', 'skyblue'], ['blue'], ['green'], ['blue', 'red'], ['blue', 'red'], ['blue', 'red'],
              ['blue', 'red']]
    
    filenames = ['gender', 'course', 'year', 'marital', 'depression', 'anxiety', 'panicattack']
    ...
    for column, title, color, filename in zip(columns, titles, colors, filenames):
        ...
        lib.bar_chart(df, column, title=title, xlabel=column, ylabel='Count', color=color)
